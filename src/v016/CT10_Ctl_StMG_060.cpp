...
//    헤더(CT10_Ctl_051.h)에 추가해야 하는 타입/멤버는 맨 아래에 따로 제공.
// ======================================================
...
const char* CT10_stateToString(EN_CT10_state_t p_s) {
    switch (p_s) {
        case EN_CT10_STATE_IDLE:
            return "IDLE";
        case EN_CT10_STATE_OVERRIDE:
            return "OVERRIDE";
        case EN_CT10_STATE_PROFILE_RUN:
            return "PROFILE_RUN";
        case EN_CT10_STATE_SCHEDULE_RUN:
            return "SCHEDULE_RUN";
        case EN_CT10_STATE_MOTION_BLOCKED:
            return "MOTION_BLOCKED";
        case EN_CT10_STATE_AUTOOFF_STOPPED:
            return "AUTOOFF_STOPPED";
        case EN_CT10_STATE_TIME_INVALID:
            return "TIME_INVALID";
        default:
            return "UNKNOWN";
    }
...
const char* CT10_reasonToString(EN_CT10_reason_t p_r) {
    switch (p_r) {
        case EN_CT10_REASON_NONE:
            return "NONE";
        case EN_CT10_REASON_OVERRIDE_ACTIVE:
            return "OVERRIDE_ACTIVE";
        case EN_CT10_REASON_PROFILE_MODE:
            return "PROFILE_MODE";
        case EN_CT10_REASON_USER_PROFILE_ACTIVE:
            return "USER_PROFILE_ACTIVE";
        case EN_CT10_REASON_SCHEDULE_ACTIVE:
            return "SCHEDULE_ACTIVE";
        case EN_CT10_REASON_NO_ACTIVE_SCHEDULE:
            return "NO_ACTIVE_SCHEDULE";
        case EN_CT10_REASON_NO_SCHEDULES:
            return "NO_SCHEDULES";
        case EN_CT10_REASON_TIME_NOT_VALID:
            return "TIME_NOT_VALID";
        case EN_CT10_REASON_MOTION_NO_PRESENCE:
            return "MOTION_NO_PRESENCE";
        case EN_CT10_REASON_AUTOOFF_TIMER:
            return "AUTOOFF_TIMER";
        case EN_CT10_REASON_AUTOOFF_TIME:
            return "AUTOOFF_TIME";
        case EN_CT10_REASON_AUTOOFF_TEMP:
            return "AUTOOFF_TEMP";
        default:
            return "UNKNOWN";
    }
...
void CL_CT10_ControlManager::applyDecision(const ST_CT10_Decision_t& p_d) {
    ...
    bool v_sourceChanged = (runSource != p_d.nextRunSource) || (curScheduleIndex != p_d.nextScheduleIndex) ||
