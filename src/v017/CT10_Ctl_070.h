...
// ------------------------------------------------------
void CT10_WS_setBrokers(void (*p_state)(JsonDocument&, bool),
...
class CL_CT10_ControlManager {
  ...
  private:
    ...
    // --------------------------------------------------
    void updateRunCtxOnSegmentOn_Schedule(const ST_A20_ScheduleItem_t& p_s, const ST_A20_ScheduleSegment_t& p_seg);
