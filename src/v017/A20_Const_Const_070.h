...
namespace A20_Const {
	...
	// 모듈별 버전 (Web API 응답용)
	constexpr char VER_CONTROL[] 				= "CT10_Ctr_070";
	constexpr char VER_CONFIG[]  				= "C10_ConfigManager_070";
	constexpr char VER_API[]     				= "W10_WebAPI_070";
	constexpr char VER_SIMUL[]   				= "S10_Simul_070";
