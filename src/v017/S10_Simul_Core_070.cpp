...
#include "S10_Simul_070.h" // (변경 반영) 헤더 포함
...
void CL_S10_Simulation::resetDefaults() {
    ...
    A40_ComFunc::copyStr2Buffer_safe(presetCode, G_A20_WindPreset_Arr[EN_A20_WINDPRESET_OCEAN].code, sizeof(presetCode));

    A40_ComFunc::copyStr2Buffer_safe(styleCode, G_A20_WindStyle_Arr[EN_A20_WINDSTYLE_BALANCE].code, sizeof(styleCode));
